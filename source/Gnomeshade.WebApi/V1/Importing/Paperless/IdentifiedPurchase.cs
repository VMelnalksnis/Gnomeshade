...
/// <param name="ClosestProduct">The closest matching product to <see cref="OriginalName"/>.</param>
/// <param name="Score">A score from 0 to 100 indicating how close <see cref="ClosestProduct"/> is to <see cref="OriginalName"/>.</param>

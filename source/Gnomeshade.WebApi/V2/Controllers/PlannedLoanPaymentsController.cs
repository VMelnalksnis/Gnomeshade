...
/// <summary>CRUD operations on planned loan payment entity.</summary>
[Route("api/v{version:apiVersion}/LoanPayments/Planned")]
public sealed class PlannedLoanPaymentsController(
	Mapper mapper,
	LoanPaymentRepository repository,
	DbConnection dbConnection)
	: CreatableBase<LoanPaymentRepository, LoanPaymentEntity, LoanPayment, LoanPaymentCreation>(mapper, repository,
		dbConnection)
{
	/// <inheritdoc cref="ILoanClient.GetLoanPaymentAsync"/>
	/// <response code="200">Successfully got the planned loan payment.</response>
	/// <response code="404">Planned loan payment with the specified id does not exist.</response>
	...
	/// <response code="201">A new planned loan payment was created.</response>
	/// <response code="204">An existing planned loan payment was replaced.</response>
	...
	/// <response code="204">Planned loan payment was successfully deleted.</response>
	/// <response code="404">Planned loan payment with the specified id does not exist.</response>
	/// <response code="409">Planned loan payment cannot be deleted because some other entity is still referencing it.</response>

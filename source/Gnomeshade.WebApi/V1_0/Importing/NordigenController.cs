...
using Gnomeshade.WebApi.V1_0.Importing.Results;
using Gnomeshade.WebApi.V1_0.Importing.TransactionCodes;
...
using static Gnomeshade.WebApi.V1_0.Importing.TransactionCodes.Family;
using static Gnomeshade.WebApi.V1_0.Importing.TransactionCodes.SubFamily;

namespace Gnomeshade.WebApi.V1_0.Importing;

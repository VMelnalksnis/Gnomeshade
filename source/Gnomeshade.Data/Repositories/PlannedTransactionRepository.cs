	...
	: Repository<PlannedTransactionEntity>(logger, dbConnection)
{
	...
	/// <inheritdoc />
	public override Task<Guid> AddAsync(PlannedTransactionEntity entity)
	{
		Logger.AddingEntity();
	...
	/// <inheritdoc />
	public override async Task<int> UpdateAsync(PlannedTransactionEntity entity)
	{
	...
	/// <inheritdoc />
	public override async Task<int> DeleteAsync(Guid id, Guid userId)
	{

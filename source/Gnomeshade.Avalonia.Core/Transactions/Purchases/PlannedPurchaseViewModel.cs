...
public sealed partial class PlannedPurchaseViewModel : OverviewViewModel<PurchaseOverview, PlannedPurchaseUpsertionViewModel>
{
	...
	private PlannedPurchaseUpsertionViewModel _details;

	/// <summary>Gets the total purchased amount.</summary>
	[Notify(Setter.Private)]
	private decimal _total;

	/// <summary>Initializes a new instance of the <see cref="PlannedPurchaseViewModel"/> class.</summary>
	...
	public PlannedPurchaseViewModel(
	...
	/// <inheritdoc />
	public override PlannedPurchaseUpsertionViewModel Details
	{
		get => _details;
		set
		{
	...
	{
		var purchases = await _gnomeshadeClient.GetPlannedPurchases(_transactionId);
		...
		var overviews = purchases
			...
			.Select(purchase => purchase.ToOverview(currencies, products, units, projects));

...
public sealed partial class PlannedLoanPaymentViewModel : OverviewViewModel<LoanPaymentRow, PlannedLoanPaymentUpsertionViewModel>
{
	private readonly IGnomeshadeClient _gnomeshadeClient;
	private readonly Guid _transactionId;
	private PlannedLoanPaymentUpsertionViewModel _details;

	/// <summary>Gets the total loaned amount.</summary>
	[Notify(Setter.Private)]
	private decimal _total;

	/// <summary>Initializes a new instance of the <see cref="PlannedLoanPaymentViewModel"/> class.</summary>
	/// <param name="activityService">Service for indicating the activity of the application to the user.</param>
	/// <param name="gnomeshadeClient">A strongly typed API client.</param>
	/// <param name="transactionId">The transaction for which to create a loan overview.</param>
	public PlannedLoanPaymentViewModel(IActivityService activityService, IGnomeshadeClient gnomeshadeClient, Guid transactionId)
	...
	/// <inheritdoc />
	public override PlannedLoanPaymentUpsertionViewModel Details
	{
		get => _details;
		set
		{
	...
	{
		var payments = await _gnomeshadeClient.GetPlannedLoanPayments(_transactionId);
		...
		Total = payments.Select(payment => payment.Amount + payment.Interest).Sum(); // todo
		Rows = new(overviews);
	...
	{
		await _gnomeshadeClient.DeletePlannedLoanPayment(row.Id);

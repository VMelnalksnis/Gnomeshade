...
using Account = Gnomeshade.Data.Models.Account;
using Transaction = Gnomeshade.Core.Imports.Fidavista.Transaction;
...
namespace Gnomeshade.Interfaces.WebApi.V1_0.Importing
{
	...
	public sealed class FidavistaController : ControllerBase
	{
			...
			Account account)
		{
			...
			var transactionEntity = new global::Gnomeshade.Data.Models.Transaction
			{
				OwnerId = user.Id,
				CreatedByUserId = user.Id,
				ModifiedByUserId = user.Id,
